            ...
            <div class="p-8">
                <form id="login_form" class="space-y-6" action="includes/login.php" method="post">
                    ...
                    <div>
                        ...
                        <input type="password" name="password" id="password" placeholder="••••••••" class="bg-white/70 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-amber-500 focus:border-amber-500 block w-full p-3 dark:bg-gray-800/70 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white/90 placeholder:text-gray-500/80 transition-all duration-200" required />
                    </div>
                    ...
                    <button type="submit" class="w-full text-white bg-amber-500 hover:bg-amber-600 focus:ring-4 focus:outline-none focus:ring-amber-300 font-bold rounded-lg text-lg px-6 py-3.5 text-center dark:bg-amber-400 dark:hover:bg-amber-500 dark:focus:ring-amber-800 transition transform hover:scale-105 duration-300 ease-in-out shadow-lg hover:shadow-xl flex items-center justify-center gap-2">
                        <svg class="w-5 h-5 -ml-1" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                            <path fill-rule="evenodd" d="M10 2a5 5 0 00-5 5v2a2 2 0 00-2 2v5a2 2 0 002 2h10a2 2 0 002-2v-5a2 2 0 00-2-2V7a5 5 0 00-5-5zm-3 7v2h6V9a3 3 0 00-6 0z" clip-rule="evenodd"></path>
                        </svg>
                        Log In
                    </button>
            ...
            <div class="p-8">
                <form id="admin_form" class="space-y-6" action="includes/admin_login.php" method="post">
                    ...
                    <div>
                        ...
                        <input type="password" name="admin_password" id="admin_password" placeholder="••••••••" class="bg-white/70 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-amber-500 focus:border-amber-500 block w-full p-3 dark:bg-gray-800/70 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white/90 placeholder:text-gray-500/80 transition-all duration-200" required />
                    </div>
            ...
            <div class="p-8">
                <form id="signup_form" class="space-y-6" action="includes/signup.php" method="post">
                    ...
                    <div>
                        ...
                        <input type="password" name="confirm-password" id="confirm-password" placeholder="••••••••" class="bg-white/70 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-amber-500 focus:border-amber-500 block w-full p-3 dark:bg-gray-800/70 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white/90 placeholder:text-gray-500/80 transition-all duration-200" required />
                    </div>
